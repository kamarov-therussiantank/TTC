...
whenContentInitialized().then(() => {
    ...
    Loader.interceptFunction(TankTrouble.TankInfoBox, '_initialize', (original, ...args) => {
        ...
        if (!TankTrouble.TankInfoBox.infoFavorites) {
            ...
            const standardIcon = $('<img class="standard" src="https://raw.githubusercontent.com/kamarov-therussiantank/TTC/refs/heads/main/src/assets/images/tankInfo/favourites.png", srcset="https://raw.githubusercontent.com/kamarov-therussiantank/TTC/refs/heads/main/src/assets/images/tankInfo/favourites%402x.png 2x">');
        ...
        TankTrouble.TankInfoBox.infoFavorites.insertBefore(TankTrouble.TankInfoBox.infoAccount);
