...
whenContentInitialized().then(() => {
    ...
    <a href="https://mail.google.com/" target="_blank" style="text-decoration: none;">
            ...
            <div class="content">
            <img src="https://raw.githubusercontent.com/kamarov-therussiantank/TTCV2/main/src/assets/snippets/tellAFriend.png" style="position: relative; top: 6px; left: 20px; pointer-events: none;">
            </div>
    </div>
    `);
